...
public class GameMessage {
    ...
    public static String characterInstructions = "To select a character push the corresponding image. If the character's action requires some specifications, there will be a menu on the right (you must first select the target in the menu and then click on the character)";
    public static String specialCommand = "\n\nAt any time you can use the command \"quit\" to quit the game (the game will be saved) \nand the command \"show deck\" to see your remaining cards\n\n";
}
