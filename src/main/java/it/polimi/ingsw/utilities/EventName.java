...
public class EventName {
    ...
    public static final String StartingGame = "StartingGame";
    public static final String DeckRequired = "DeckRequired";
    public static final String AvailableCharactersRequired = "AvailableCharactersRequired";
}
